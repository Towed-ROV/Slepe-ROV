...
if __name__ == "__main__":
    ...
    sea_floor_tracker = SeafloorTracker(length_rope=200, desired_distance=20, min_dist=12, dist_to_skip=6,
                                        depth_of_rov=10, depth_beneath_boat=seafloor_sonar_queue,

...
float magn_ellipsoid_center[3] = { -232.402, 860.122, -383.306};
float magn_ellipsoid_transform[3][3] = {{0.893656, 0.191444, -0.00238002}, {0.191444, 0.359848, 0.159303}, { -0.00238002, 0.159303, 0.918626}};
...
boolean get_connection_bool = false;
boolean reset1 = false;
String data_string = "";
int message = 99;
const int serial_established = 1;
const int  reset_imu = 2;
int test1 = 0;
...
void loop()
{
//  reset1 = check_for_reset();
  if (not get_connection_bool or reset1){
    get_connection_bool = get_connection();
